...
public class BeautifulArrangement526 {
    ...
    //3/1/2026 暴力dfs吧,到底dfs的意义是什么，没太想清楚
    int rs2=0;
    ...
    //begin的意义是现在考察begin这个index，如果放数字i~n，那么这个index和i是否可以整除
    void dfs2(int begin,int n,boolean[] memo){
        if(begin==n+1){
            rs2++;
            return;
        }
